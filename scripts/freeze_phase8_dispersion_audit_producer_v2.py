"""Refreeze the Phase 8 dispersion audit after the dependency-lock update."""
...
OUTPUT = (
    ROOT / "artifacts" / "phase8_bridge" / "dispersion_audit_producer_freeze_v2.json"
)
EXECUTABLE_SCRIPTS = (
...
def build_freeze() -> dict[str, Any]:
    ...
    document: dict[str, Any] = {
        "schema_version": "phase8-dispersion-audit-producer-freeze-v2.0",
        ...
        "supersedes": "artifacts/phase8_bridge/dispersion_audit_producer_freeze_v1.json",
        "supersession_reason": "DEPENDENCY_LOCK_UPDATED_BY_DEPENDABOT_PRS_8_AND_9",
