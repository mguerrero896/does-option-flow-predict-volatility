...
from mds650.config import effective_data_root, provisional_data_root
...
NEW_PANEL = DATA_ROOT / "b2_confirmation" / "derived" / "panel_60d.parquet"
...
def main() -> None:
    ...
    if delay != 60:
        NEW_PANEL = (
            DATA_ROOT / "b2_confirmation" / "derived" / f"panel_60d_delay{delay}.parquet"
        )
