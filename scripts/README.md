...
| `scripts/audit_successor_holdout_exposure_v1.py` | CONTROLLED | Audit successor-holdout exposure from a supplied target-free panel; it reads only the session calendar and eligibility flag. |
