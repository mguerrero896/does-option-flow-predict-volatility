"""Freeze the executable closure of the Phase 8 dispersion audit and replay."""
...
def build_freeze() -> dict[str, Any]:
    ...
    document: dict[str, Any] = {
        "schema_version": "phase8-dispersion-audit-producer-freeze-v1.0",
...
def main() -> None:
    ...
    print(f"[phase8-dispersion] froze audit producer closure at {output}")
