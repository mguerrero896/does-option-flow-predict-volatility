...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    # CodeQL py/clear-text-logging-sensitive-data fires here because the dict is
    # derived from os.environ lookups of secret names. Reviewed 2026-08-25: only
    # BOOLEANS (is the secret set?) are constructed and printed - never a value.
    secret_presence = {
