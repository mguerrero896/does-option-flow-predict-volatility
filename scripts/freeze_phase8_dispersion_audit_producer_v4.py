"""Refreeze the Phase 8 dispersion audit after the completed dependency queue."""
...
def build_freeze() -> dict[str, Any]:
    ...
    document: dict[str, Any] = {
        "schema_version": "phase8-dispersion-audit-producer-freeze-v4.0",
        ...
        "supersedes": "artifacts/phase8_bridge/dispersion_audit_producer_freeze_v3.json",
        "supersession_reason": "DEPENDENCY_LOCK_UPDATED_BY_DEPENDABOT_PRS_24_TO_26",
