"""Refreeze the Phase 8 dispersion audit after B1 spot-cutoff remediation."""
...
OUTPUT = (
    ROOT / "artifacts" / "phase8_bridge" / "dispersion_audit_producer_freeze_v6.json"
)
EXECUTABLE_SCRIPTS = (
...
def build_freeze() -> dict[str, Any]:
    ...
    document: dict[str, Any] = {
        "schema_version": "phase8-dispersion-audit-producer-freeze-v6.0",
        ...
        "supersedes": "artifacts/phase8_bridge/dispersion_audit_producer_freeze_v5.json",
        "supersession_reason": "RP2_V3_B1_SPOT_CUTOFF_REMEDIATION",
