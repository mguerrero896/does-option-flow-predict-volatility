...
from mds650.rp2.ladder import PRIMARY_MODELS, assert_primary_models, fit_ladder_model
    ...
    for model_name in models:
        ...
        for set_name in INFORMATION_SETS:
            forecast = fit_ladder_model(
                model_name, designs[set_name], target, train, sessions=sessions_rank
            )
        ...
        for asset in sorted({str(a) for a in assets}):
            ...
            for set_name in INFORMATION_SETS:
                ...
                forecast = fit_ladder_model(
                    model_name, asset_design, target, asset_train, sessions=sessions_rank
                )
