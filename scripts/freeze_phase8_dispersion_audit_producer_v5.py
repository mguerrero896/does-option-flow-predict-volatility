"""Refreeze the Phase 8 dispersion audit after RP2-v3 timing remediation."""
...
def build_freeze() -> dict[str, Any]:
    ...
    document: dict[str, Any] = {
        "schema_version": "phase8-dispersion-audit-producer-freeze-v5.0",
        ...
        "supersedes": "artifacts/phase8_bridge/dispersion_audit_producer_freeze_v4.json",
        "supersession_reason": "RP2_V3_TIMING_AND_PARTITION_ROLE_REMEDIATION",
