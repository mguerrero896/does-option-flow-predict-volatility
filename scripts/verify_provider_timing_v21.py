...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    # CodeQL flags this print as sensitive-data logging via the hygiene scanner.
    # Reviewed 2026-08-25: hygiene carries only FILE NAMES of files matching the
    # secret pattern, never file contents or secret values.
