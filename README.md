...
- **Timing limitation:** timely order flow is not demonstrated (placebo p = 0.255); most of the linear increment survives a within-asset-session flow shuffle. [Completed placebo and interpretation](docs/CURRENT.md).
