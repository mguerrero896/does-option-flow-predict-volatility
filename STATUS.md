...
- Governance: decision 113 is the latest (113 recorded).
- Frozen evidence: 103 artifacts registered; 101 are present in this release and 2 remain gated or withdrawn with their digests preserved in `data/FROZEN_ARTIFACTS.json`.
...
- Post-cutoff Phase 8A result: `reports/phase8a_exploratory_bridge_addendum_v10.md`.
