...
- Governance: decision 115 is the latest (115 recorded).
- Frozen evidence: 109 artifacts registered; 107 are present in this release and 2 remain gated or withdrawn with their digests preserved in `data/FROZEN_ARTIFACTS.json`.
- Public metadata redactions: 12 frozen artifacts retain original and redacted SHA-256 custody in `data/PUBLIC_METADATA_REDACTIONS.json`.
...
- Scientific hash: `7d544aa334b70ce8bc2d25d26bd1f984068b8f753aebe039fc59ae2a44719db3`.
- Code provenance: recorded run commit `cbdd0b5840da` is reachable from this root release.
...
- Post-cutoff Phase 8A result: `reports/phase8a_exploratory_bridge_addendum_v11.md`.
