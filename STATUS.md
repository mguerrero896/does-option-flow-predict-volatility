...
- Governance: decision 111 is the latest (111 recorded).
- Frozen evidence: 100 artifacts registered; 98 are present in this release and 2 remain gated or withdrawn with their digests preserved in `data/FROZEN_ARTIFACTS.json`.
...
- Post-cutoff Phase 8A result: `reports/phase8a_exploratory_bridge_addendum_v9.md`.
