...
- Governance: decision 108 is the latest (108 recorded).
- Frozen evidence: 91 artifacts registered; 89 are present in this release and 2 remain gated or withdrawn with their digests preserved in `data/FROZEN_ARTIFACTS.json`.
...
- Post-cutoff Phase 8A result: `reports/phase8a_exploratory_bridge_addendum_v6.md`.
