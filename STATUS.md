...
- Governance: decision 105 is the latest (105 recorded).
- Frozen evidence: 85 artifacts registered; 83 are present in this release and 2 remain gated or withdrawn with their digests preserved in `data/FROZEN_ARTIFACTS.json`.
...
- Post-cutoff Phase 8A result: `reports/phase8a_exploratory_bridge_addendum_v3.md`.
