...
- Governance: decision 106 is the latest (106 recorded).
- Frozen evidence: 87 artifacts registered; 85 are present in this release and 2 remain gated or withdrawn with their digests preserved in `data/FROZEN_ARTIFACTS.json`.
...
- Post-cutoff Phase 8A result: `reports/phase8a_exploratory_bridge_addendum_v4.md`.
