...
- Governance: decision 102 is the latest (102 recorded).
- Frozen evidence: 73 artifacts registered; 71 are present in this release and 2 remain gated or withdrawn with their digests preserved in `data/FROZEN_ARTIFACTS.json`.
...
- Supabase publication: **NO_CURRENT_RESULTS_PUBLICATION_AND_DIRECT_DML_DISABLED_DATASET_REGISTRY_EXACT** (19 schema migrations, 1 catalog reconciliation, and 6 dataset manifests committed; sealed reads 0).

## Active protocols

- **phase8-prospective-bridge** — `docs/phase8_bridge_protocol_v2.md`: FROZEN_EXPLORATORY_BRIDGE_READ_NOT_AUTHORIZED
...
- Phase 8 bridge method is frozen; one-shot execution requires separate authorization after the 30-session acquisition completes
