...
- Governance: decision 129 is the latest (128 recorded).
- Frozen evidence: 154 artifacts registered; 152 are present in this release and 2 remain gated or withdrawn with their digests preserved in `data/FROZEN_ARTIFACTS.json`.
