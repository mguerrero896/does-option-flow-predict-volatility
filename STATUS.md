...
- Frozen evidence: 81 artifacts registered; 79 are present in this release and 2 remain gated or withdrawn with their digests preserved in `data/FROZEN_ARTIFACTS.json`.
...
- **phase8-prospective-bridge** — `docs/phase8_bridge_protocol_v2.md`: EXPLORATORY_BRIDGE_EVALUATION_COMPLETE_WITH_RECORDED_RECOVERY
...
- Post-cutoff Phase 8A result: `reports/phase8a_exploratory_bridge_addendum_v1.md`.
