...
- Frozen evidence: 145 artifacts registered; 143 are present in this release and 2 remain gated or withdrawn with their digests preserved in `data/FROZEN_ARTIFACTS.json`.
...
- State authority: `artifacts/gate5_pit/uw_latency_campaign_state_20260902_v2.json`.
