...
generated it. Unrelated local-checkout changes, including local developer
tooling, are outside this narrow builder-source check.

## Retained noncanonical runs

`<DATA_ROOT>/phase6/derived/target_blind_v23/` and
...
`<DATA_ROOT>/phase6/derived/target_blind_v23_sourcebound_20260812/`

and its repository artefacts under:

`artifacts/target_blind_v23_sourcebound_20260812/`.

`<DATA_ROOT>/phase6/derived/target_blind_v23_committed_20260812/` and
