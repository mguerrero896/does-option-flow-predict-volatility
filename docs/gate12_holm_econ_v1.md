...
True HARQ on dev (Design B), remeasured: B1→B2 and HARQ→B2_total null; HARQ→B1 reads
−0.0030 with wild p 0.040 — adding the B1 surface to true HARQ *hurts* on the
development era at the raw 5% level (it does not survive the global Holm family), a
direction consistent with, and mildly reinforcing, the measured 2026 fade. Conclusion:
