...
> [`confirmation_protocol_v4_sourcebound.md`](confirmation_protocol_v4_sourcebound.md).
...
uv run python scripts/build_b2_availability_v22.py `
  --event-root <DATA_ROOT>\phase6\data\option_events `
  --matrix-root <DATA_ROOT>\phase6\data\b2\raw_activity_by_session `
  --expected-origins-path <DATA_ROOT>\phase6\data\b1q\phase6_b1_origins.parquet `
  --traceability-csv artifacts\provider_timing_v21\b2_canonical_traceability_v21.csv `
  --sidecar-output <DATA_ROOT>\phase6\derived\provider_timing_v22\b2_row_availability_v22.parquet `
