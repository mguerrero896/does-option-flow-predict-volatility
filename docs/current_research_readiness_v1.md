...
> **HISTORICAL SNAPSHOT — 2026-08-12.** “Current” is part of the recorded artifact name,
> not a statement about the repository today. See [`STATUS.md`](../STATUS.md) and
> [`data/CANONICAL_STATE.json`](../data/CANONICAL_STATE.json) for the current state.
