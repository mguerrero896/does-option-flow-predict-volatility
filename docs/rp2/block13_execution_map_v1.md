...
| 7 | Orthogonalization | DML of B2 on B0+B1 | preliminary incremental evidence | **PASS in D only** — `SUPERSEDED_BY_RP2_V3`. The figures this row carried (~~joint Wald 501.9 full / 206.8 core, p = 6 × 10⁻³⁹ in D; core p = 0.059 in V~~) reproduce against no artifact in the tree, and the 58-treatment "full" design is not reproducible with the current code, which fits twelve. On `rp2-v3-20260822-114000`: core D Wald 98.75420, p = 9.67324e-17; full D 99.51768, p = 6.92052e-16; core V 5.79616, p = 0.832088. See `docs/rp2/block7_dml_v1.md` §0 |
