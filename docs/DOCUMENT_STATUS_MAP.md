...
| [Retained English defense package](rp4/DEFENSE_PACKAGE/revision_2/correction_7/README.md) | HISTORICAL | Presentation snapshot with preserved translation bindings. Its pending PIT/placebo labels are superseded by the [subsequent status](CURRENT.md#reading-the-retained-defense-package); other commitments are not automatically closed. |
