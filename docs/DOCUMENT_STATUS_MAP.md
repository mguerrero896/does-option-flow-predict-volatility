...
| [Completed linear RV15 placebo summary](../artifacts/rp4_robustness_public_v1/placebo_log_ridge_harq_rv15_summary.csv), [provenance](../artifacts/rp4_robustness_public_v1/import_receipt.json) and [interpretation](FAQ.md#13-does-the-placebo-support-timely-flow-information) | CURRENT | Closed post-primary robustness evidence; timely order flow is not demonstrated. No separate public placebo report is available in this import; other robustness stages are not certified by this closure. |
