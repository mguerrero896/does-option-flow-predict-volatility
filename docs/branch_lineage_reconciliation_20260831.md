...
| `remediation-20260821` | `3dc873d15e22bb34c356aad36b0445dc3a26e769` | Disjoint | Current `main` contains the ancestry, watchdog, collector and task-liveness controls or stronger successors. An obsolete automation integration and migration remain audit-only. |
