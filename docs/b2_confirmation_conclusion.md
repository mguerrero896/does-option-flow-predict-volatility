...
> **SUPERSEDED HISTORICAL CONCLUSION.** The measurements below do not define the current
> scientific claim. Consult [`data/CANONICAL_STATE.json`](../data/CANONICAL_STATE.json) and
