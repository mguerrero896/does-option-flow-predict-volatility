...
> **SUPERSEDED AUTHORITY.** This ledger is retained for audit but no longer governs the
> report or defense. Use [`data/CANONICAL_STATE.json`](../data/CANONICAL_STATE.json) for
