...
> **HISTORICAL — DO NOT CITE AS CURRENT.** This document records an earlier validation
> state. Current eligibility is defined by [`data/CANONICAL_STATE.json`](../data/CANONICAL_STATE.json),
> projected in [`STATUS.md`](../STATUS.md); retired measurements are indexed in
