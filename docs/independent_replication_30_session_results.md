...
> **SUPERSEDED HISTORICAL RESULT.** Subsequent input and protocol reconciliation withdrew
> this document as current evidence. Use [`data/CANONICAL_STATE.json`](../data/CANONICAL_STATE.json)
> for eligibility and [`docs/rp2_v3/SUPERSEDED_RESULTS.md`](rp2_v3/SUPERSEDED_RESULTS.md)
> for the correction trail.
