...
registered classification (A, B, C, D) are all publishable results.
...
registered prospective confirmation begins only after this
...
- [`STUDY_WINDOW.md`](STUDY_WINDOW.md) — the adopted sample window and its evidence.
