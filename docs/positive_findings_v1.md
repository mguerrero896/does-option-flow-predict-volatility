...
> **SUPERSEDED EXPLORATORY RECORD — DO NOT PRESENT AS A CURRENT RESULT.** Later
> reconciliation retired these measurements. Current eligibility is fail-closed in
> [`data/CANONICAL_STATE.json`](../data/CANONICAL_STATE.json); reasons are preserved in
