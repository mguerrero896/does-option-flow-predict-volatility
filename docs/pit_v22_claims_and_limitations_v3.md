# PIT v2.2 successor â€” holdout-exposure addendum v3
...
role is `EXPLORATORY_DESCRIPTIVE`. A methodology change can permit reuse or alter a future design, but cannot
restore independence after outcomes were exposed.
