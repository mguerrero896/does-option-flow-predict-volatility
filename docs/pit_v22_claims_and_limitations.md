...
| PITV22-C002 | PROXY_ONLY | The measured live receipt latency campaign is RECONCILED_PARTIAL; Unusual Whales created_at remains only an operational availability proxy at the registered cutoff. | The cross-channel design cannot identify backfill or revision and does not prove provider publication time or client receipt time. | docs/provider_timing_pit_contract_v21.md; docs/provider_timing_claim_matrix_v21.md; artifacts/gate5_pit/uw_latency_campaign_state_20260901_v1.json |
