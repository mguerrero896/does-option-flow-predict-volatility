...
| LIT-010 | [Omer, Månsson, Sjölander & Uddin (2026)](https://doi.org/10.1002/for.70107) | Published; Wiley/DiVA full text | RR, LASSO, ELNET, RT, RF, NN5, NN10, sg-LASSO, HAR/HAR-XX, rolling evaluation and the reported missing-value imputation are checked; this study must not import that imputation policy. |
