...
126. **The PR #55 panel-reuse record is corrected additively: source admission is
     ...
     | Tier 2 | **SEVEN OF SEVEN GATES PASSED WITH THE LICENSED OPT-OUTS ABSENT.** `scripts/run_local_evidence_gates.py` constructs an explicit inherited environment after removing `MDS650_PANEL_GUARD_MAY_SKIP` and `MDS650_UW_LATENCY_FRESHNESS_MAY_SKIP` case-insensitively for every licensed gate. Only the hermetic CI replica declares both as `1`. At `2026-09-01T19:55:45.867116+00:00`, rebased implementation commit `a40f42c9f7ebacadb11b34188d41dc5da3cbdaab` (tree `e2bdc6c7ec214c92f3cf324e4c97a76501fa40dd`) returned code zero for `versioned-hook`, `ruff`, `mypy`, `full-pytest`, `ci-sim`, `gated-hashes` and `access-posture`; `c1e331e247d411eb21141b1cd271130ae16bfd89` is a required ancestor. The current immutable JSON is `artifacts/local_evidence_gates/pr55_remediation_20260902_v2.json`, canonical LF SHA-256 `cfc71d0dc41e75d1ab32bbf939a48ecd21d83faef172251698c3f98ef3d4d490`; frozen `v1` remains as the earlier pre-rebase evidence instead of being overwritten. A prior clean-tree run was RED at 5/7, exposing the stale UW inventory and the now-landed PR #62 `ProgramFiles` omission before this GREEN run. |
