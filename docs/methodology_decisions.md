...
126. **The PR #55 panel-reuse record is corrected additively: source admission is
     ...
     | UW freshness needed by Tier 2 | **NO FROZEN SNAPSHOT WAS OVERWRITTEN.** The first 2026-09-02 snapshot recorded 12 collected, six reconciled and six unreconciled sessions. After the rebased Tier 2 run, the licensed inventory gained only `collector_summary.json` for 2026-09-01: counts, reconciliation status and every latency aggregate remained unchanged. Current authority therefore advances additively to `uw_latency_campaign_20260902_v2.json` (file SHA-256 `c234b7cf0f13a177b398955b282124da1a4f69d35da64481f64c8037b10eb6f4`, byte-identical to v1) and `uw_latency_campaign_state_20260902_v2.json` (file SHA-256 `7a252d6cb3e7e5ab1bd409af832423c7fde307527f40be8cd1dbd61743c43feb`, semantic SHA-256 `6b34960a909ad1e87acf4d9e5ab367838a44f2578aa39539537b8f06fc59c5a3`). The 2026-09-02 v1 pair and both 2026-09-01 pairs remain frozen. No provider row is versioned and `sealed_cohort_read=false`. |
