...
| Public result scope | Later candidates originally excluded until audited | V4 keeps the headline. The closed, independently audited v5 registered exploratory extension (decision 134) may be reported separately, with its primary selector failure and all comparative results. Unaudited universe extensions, placebo and other PIT experiments remain outside this release. | [Publication review](public_repository_review.md), [v5 report](rp4/results_v5.md) |
