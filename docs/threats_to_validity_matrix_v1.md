...
| 5 | Serial dependence and interval calibration | Five-minute origins overlap; the 0.784 empirical coverage measurement against nominal 0.95 belongs to the superseded RP2 run and has no eligible post-PIT replication | Aggregate to sessions; block bootstrap, Newey-West and wild-cluster diagnostics | Intervals may still undercover, especially in short V |
