...
La autoridad de lectura es [RESULTADO_FINAL.md](RESULTADO_FINAL.md), revisión
...
Fuentes:
[datos y ejecución v1](data_and_execution_v1.md),
[errata v2](results_v2.md),
[informe original v3](results_v3.md),
[secundarios finales v3](results_v3_revision2.md),
...
El [RUNBOOK](OPERATING_GUIDE.md) contiene comandos de verificación que no ajustan modelos
