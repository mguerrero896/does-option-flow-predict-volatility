...
Audit checkpoint: 2026-08-11, historical validation snapshot.
...
| Notebook execution | execute every code cell in the earlier `canonical_rv30_defense.ipynb` with `uv run python` (superseded in September 2026 by the verification notebooks; see `notebooks/README.md`) | **PASS** |
...
this validation checkout. They are not converted to passes.
...
validation documents are additive.
