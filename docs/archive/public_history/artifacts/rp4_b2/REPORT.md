...
```powershell
uv run --offline --frozen --no-sync python -B artifacts/rp4_code/evaluate.py --panel private-input/c1ae6ab902047da171cf --spec artifacts/rp4_a1/specification.json --spec-sha256 865865558087108356f4eb6da7f9d431f1c4d32fd330f20ea78eb126ec6462a5 --window primary --output private-input/3bd2e9f28f3a26ad7ed1 --public-output artifacts/rp4_b2 --threads 4
```
