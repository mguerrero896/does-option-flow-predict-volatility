...
Leer el [informe v1/v2/v3](../../../../rp4/results_v3.md) junto con las [notas de interpretación y límites](READING_NOTES.md). Las notas forman parte del paquete B4 y aclaran los secundarios de saltos y recalibración; no cambian los resultados ni el procedimiento congelado.
...
|---|---|---|
| A1 | [Especificación v3](../../docs/rp4/specification_v3.md) | [Recibo A1](../../../../../artifacts/rp4_v3_a1/receipt.json) |
| A1B | [Regla de ventanas vacías](../../docs/rp4/v3_window_empty_addendum.md) | [Recibo A1B](../../../../../artifacts/rp4_v3_a1_empty_window/receipt.json) |
| A2 | [Re-derivación, comparación y materialización](../rp4_v3_a2/REPORT.md) | [Recibo A2](../../../../../artifacts/rp4_v3_a2/receipt.json) |
| B2 | [Primaria](../../../../../artifacts/rp4_v3_b2/summary.json) | [Recibo B2](../../../../../artifacts/rp4_v3_b2/receipt.json) |
| B3 | [Confirmación](../../../../../artifacts/rp4_v3_b3/summary.json) | [Recibo B3](../../../../../artifacts/rp4_v3_b3/receipt.json) |
| B4 | [Informe](../../../../rp4/results_v3.md), tablas CSV y dos figuras | [Recibo B4](../../../../../artifacts/rp4_v3_b4/receipt.json) y [manifiesto del generador](../../../../../artifacts/rp4_v3_b4/report_manifest.json) |
...
- [Comprobación de identidad MZ en primaria](../../../../../artifacts/rp4_v3_b4/audit_mz_identity.py) y [recibo](../../../../../artifacts/rp4_v3_b4/mz_identity_receipt.json): aritmética de predicciones ya cerradas; no vuelve a entrenar modelos.
- [142 pruebas previas y verificaciones focalizadas](../../../../../artifacts/rp4_v3_a2/verification_before_fit.json): alcance concreto, no una afirmación de pruebas completas de todo el repositorio.
