...
Fuentes: [tabla completa por versión](../../../rp4/RESULTADO_FINAL.md), [datos agregados de la comparación](../../../../artifacts/rp4_closeout_figures/comparison_v1_v4.csv), [antecedente y alcance de v4](../../../rp4/specification_v4.md), [registro prospectivo](../../../rp4/prospective_confirmation_v1.md).
...
Fuentes: [regla de cierre y límites](../../../rp4/specification_v4.md), [decisiones primarias](../../../../artifacts/rp4_v4_b4/primary_statistics.csv), [decisión prospectiva](../../../rp4/prospective_confirmation_v1.md).
...
Fuentes: [comparación por horizonte](../../../rp4/results_v4.md), [p formal, p nominal y estado de hipótesis](../../../../artifacts/rp4_v4_b4/primary_statistics.csv).
...
Una mediana positiva y una media negativa pueden coexistir: pérdidas adversas de mayor magnitud pueden pesar más sobre la media. Aquí no se cambia de estadístico para salvar el resultado primario. Además, mediana de diferencias pareadas no es diferencia de medianas de dos series. La enmienda prospectiva vuelve explícita esta distinción para su prueba secundaria de árboles.

Fuentes: [distribuciones secundarias registradas](../../../../artifacts/rp4_v4_b4/distribution_secondary.csv), [tablas legibles de secundarios](../../../rp4/results_v4.md), [secundario prospectivo B](../../../rp4/prospective_confirmation_v1_amendment_1.md).
...
Fuentes: [escala, signos y límites de los coeficientes](../../../../artifacts/rp4_closeout_audit/REPORT.md), [resumen por columna y horizonte](../../../../artifacts/rp4_closeout_audit/b2_coefficient_summary.csv), [secundario prospectivo A](../../../rp4/prospective_confirmation_v1_amendment_1.md).
...
Fuentes: [diseño y divulgaciones](../../../rp4/RESULTADO_FINAL.md), [máscaras temporales y límites de la comprobación](../../../../artifacts/rp4_closeout_audit/REPORT.md), [especificación v4](../../../rp4/specification_v4.md), [cohorte prospectiva](../../../rp4/prospective_confirmation_v1.md).
...
Fuentes: [definición, efecto e intervalo original](../../../rp4/results_v4.md), [estimaciones originales](../../../../artifacts/rp4_v4_b4/primary_statistics.csv), [definición explícita del intervalo reescalado](../../../../artifacts/rp4_closeout_figures/comparison_v1_v4.csv).
...
Fuentes: [método de relojes y límites](../../../../artifacts/rp4_market_audit/REPORT.md), [divulgación PIT](../../../rp4/RESULTADO_FINAL.md), [límites de la adquisición prospectiva](../../../rp4/prospective_confirmation_v1.md).
...
La decisión principal se lee una vez al completar las primeras 20 sesiones elegibles: confirma sólo si H1 y H2 rechazan en la familia lineal a RV15 según su secuencia registrada. No permite cambiar a árboles, RV5 o mediana después del resultado. Las primeras 40 sesiones acumuladas, si se realiza esa lectura, informan estabilidad y no rescatan una primera lectura negativa ni constituyen una réplica independiente. El tamaño registrado no garantiza potencia suficiente; no se ha estimado aquí una probabilidad de éxito.

Fuentes: [cohorte, lectura y criterio de sesión completa](../../../rp4/prospective_confirmation_v1.md), [enmienda vigente de horario y secundarios](../../../rp4/prospective_confirmation_v1_amendment_1.md), [recibo de la enmienda](../../../rp4/prospective_confirmation_v1_amendment_1_receipt.json).
...
La ablación y la mediana pareada de árboles RV15 se leen una sola vez con las primeras 20 sesiones. La primera usa p unilateral y la segunda p bilateral; las decisiones secundarias exigen signo positivo y Holm entre ambas al 5 %. No cambian el primario, no se vuelven a contrastar en la lectura de 40 y no se reclama control global sobre su unión con la prueba primaria. Una ablación favorable no demostraría inventario real ni cobertura causal: el bloque incluye un conteo de operaciones, además de medidas de desbalance.

Fuentes: [comparadores, entrenamiento, multiplicidad y límites de la enmienda](../../../rp4/prospective_confirmation_v1_amendment_1.md), [cadena de registro](../../../rp4/prospective_confirmation_v1_amendment_1_receipt.json), [límites de los coeficientes históricos](../../../../artifacts/rp4_closeout_audit/REPORT.md).
...
La tarea no despierta el equipo y puede ejecutarse cuando vuelva a estar disponible; el colector obtiene la última sesión cerrada y no promete recuperar automáticamente una interrupción prolongada. Es un riesgo de acumulación y calendario, no motivo para redefinir una sesión completa. Si una prueba secundaria no es computable, conserva su estado; para ajustar la otra se mantiene la familia de multiplicidad sin presentar el valor administrativo como una estimación.

Fuentes: [criterios de completitud y ausencias](../../../rp4/prospective_confirmation_v1.md), [limitaciones del colector y tratamiento de secundarios no computables](../../../rp4/prospective_confirmation_v1_amendment_1.md).
...
Fuentes: [operaciones de verificación y reproducción](../../../rp4/OPERATING_GUIDE.md), [manifiesto del informe v4](../../../../artifacts/rp4_v4_b4/report_manifest.json), [alcance de la auditoría descriptiva](../../../../artifacts/rp4_closeout_audit/findings.json), [custodia prospectiva](../../../rp4/prospective_confirmation_v1.md).
