...
- Secundario B: RV15 LightGBM, mediana de las diferencias pareadas B2/B1;
  p bilateral.
- Decisiones secundarias: lectura única junto a las 20; Holm entre los dos
  secundarios al 5 % y signo positivo; no alteran el primario.

**Notas del orador.** El registro original permanece íntegro y la enmienda tiene
hash y recibo propios, anteriores a la primera adquisición observada; son
...
deltas por sesión, no la diferencia de dos medianas. Los dos secundarios se
