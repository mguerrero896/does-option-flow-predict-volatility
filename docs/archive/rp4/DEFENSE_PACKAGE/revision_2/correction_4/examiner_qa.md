...
| --- | --- | --- | --- |
| Pregunta incremental y B0 ⊂ B1 ⊂ B2; barras de un minuto, estado de contratos/cotizaciones y actividad por operación | Se conservan las capas anidadas precio/historia, estado/superficie y composición/actividad/desbalance. | **ALINEADO** en pregunta y tipos de información; no implica tres proveedores independientes: superficie y flujo pueden compartir operaciones y campos del proveedor. | [Propuesta](proposal_source_extract.json) · [Entradas y variables](../../../../../rp4/specification_v1.md) · [Registro efectivo](../../../../../../artifacts/rp4_v3_a1_empty_window/specification.json) |
