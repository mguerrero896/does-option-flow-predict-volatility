...
H2 árboles RV5 conserva sólo un p unilateral nominal; no se reabre su prueba registrada. La comparación posterior no corrige la búsqueda histórica ni crea una regla registrada nueva. [Filas fuente y límites](holm_evidence.json).
