...
-- Audit finding 2026-08-25: this file MIXES statements that were later applied in
-- other forms with statements never applied at all. Running it would partially
-- duplicate applied DDL with no transaction. Any element still wanted must be
-- carried into a NEW dated migration after checking the live schema; this file is
-- design history requiring the owner's signature, not an executable migration.
-- ===============================================================================
