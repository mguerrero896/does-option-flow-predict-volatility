-- DRAFT - NEVER APPLIED AS WRITTEN (reconciled 2026-08-25).
-- This 36.9 KB draft predates the migration Supabase actually recorded as
-- applied (20260821034446_rp2_v3_versioned_results.sql, 8.1 KB - now versioned
-- verbatim in supabase/migrations/). It is preserved as design history only;
-- running it against the live project would be wrong.
