...
ROOT = Path("D:/MDS650/artifacts/rp4_20260907")
PHASE9 = Path("D:/MDS650/phase9/raw")
...
def reuse_local_tape(day: date, spec_hash: str) -> dict[str, Any] | None:
    ...
    if prior := _reuse(receipt, spec_hash):
        return prior
    source = Path(f"D:/MDS650/uw_latency/sessions/{day}/historical_tape_{day}.zip")
...
def acquire_treasury(year: int, spec_hash: str) -> dict[str, Any]:
    ...
    old_path = Path(f"D:/MDS650/phase6/raw/fmp_exogenous_v1/treasury_{year}.xml")
