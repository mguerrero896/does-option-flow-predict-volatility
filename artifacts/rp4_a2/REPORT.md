...
Panel privado: `D:/MDS650/artifacts/rp4_20260907/a2_combined_v2/panel.parquet`.
...
La [tabla de cobertura](coverage.csv) contiene las 150 combinaciones
...
Los [agregados y hashes](summary.json) contienen las comparaciones por activo
...
no se recuperó tras interrumpirse el transporte de sus agentes por límite de
