...
`D:/MDS650/artifacts/rp4_20260907/a2`; no se usan para ajustar ni evaluar modelos.
...
```text
uv run --offline --frozen --no-sync python -B artifacts/rp4_code/materialize.py --spec artifacts/rp4_a1/specification.json --spec-sha256 865865558087108356f4eb6da7f9d431f1c4d32fd330f20ea78eb126ec6462a5 --output-root D:/MDS650/artifacts/rp4_20260907 --start 2024-08-02 --end 2026-07-31 --stage A2_v2_AAPL --assets AAPL
```
