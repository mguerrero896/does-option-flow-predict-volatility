...
> SHA-256 del original conservado: `0561ec8603e80d634ab1a7c1a0b264dbef54d34e66512d61409d9ff7dee87dab`.
> Los hashes y comandos históricos describen el original; [correspondencia de bytes](../rp4_publication_v1/manifest.json).
...
La [decisión 128](../../docs/methodology_decisions.md#L2401)
...
Raíz exacta: `D:/MDS650/registered_runs/rp2_v3/rp2-v3-20260901-flow-session-loss-registration`.
...
[COLUMNS.md:466](COLUMNS.md#L466).
...
- Las griegas existentes se calculan con Black-Scholes e IV suministrada al
  ...
  Fuente: [flow.py:56](../../src/mds650/rp2/flow.py#L56)
  y [productor:434](../../scripts/rp2_block6_flow_panel.py#L434).
- `gamma_flow` usa `gamma × size × 100 × direction × spot²`.
  No equivale al posicionamiento gamma por OI solicitado.
  Fuente: [productor:447](../../scripts/rp2_block6_flow_panel.py#L447).
- La intensidad existente es actividad con decaimiento y parámetros suministrados,
  ...
  Fuente: [flow.py:96](../../src/mds650/rp2/flow.py#L96).
- Los diagnósticos se distinguen explícitamente en el contrato actual;
  ...
  [contrato:50](../../tests/contract/test_feature_registry_reaches_the_panel.py#L50).
