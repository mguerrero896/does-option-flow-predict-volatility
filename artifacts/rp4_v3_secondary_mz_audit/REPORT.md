...
El auditor nuevo conserva las expresiones del [auditor primario](../rp4_v3_b4/audit_mz_identity.py). Una prueba AST compara sus expresiones de transformación afín, piso, QLIKE, agregación y coeficientes cerrados. Sólo cambian la ventana, sus rutas/conteos y los controles de procedencia y recursos.
...
- [Resumen agregado](confirmation_summary.json) y [tabla reproducida](confirmation_table.csv).
- [Recibo y hashes de entradas](receipt.json).
