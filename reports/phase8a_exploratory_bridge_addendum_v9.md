# Phase 8A exploratory bridge addendum v9
...
**Current authority:** This addendum supersedes v8 for the Phase 8A interpretation. The
v1–v8 paths remain frozen as audit evidence.
...
in `artifacts/phase8_bridge/dispersion_audit_producer_freeze_v3.json`. It contains the
...
`daa90f4329329adba6f1d383f07a248bee5e5ed5d7b302db0825fa791a8609d4`, and
its semantic self-hash is
`60c9a3b4482cfe0f8746e0c121442bf5af29a714d94c0c2aeb35cce716595c16`.
Dependabot PRs #22 and #23 changed the dependency lock, so this append-only freeze
supersedes v2 without altering the measured cells. The audit verifies the runtime closure
...
`artifacts/phase8_bridge/dispersion_audit_20260830_v8.json`. Its writer refuses any
