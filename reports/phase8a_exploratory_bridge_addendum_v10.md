# Phase 8A exploratory bridge addendum v10
...
**Current authority:** This addendum supersedes v9 for the Phase 8A interpretation. The
v1–v9 paths remain frozen as audit evidence.
...
in `artifacts/phase8_bridge/dispersion_audit_producer_freeze_v4.json`. It contains the
...
`a80dfd69dcc1fcc06ce68de7fd3ca3f334d2c0f029e65ae594f4ad232eb8e2c0`, and
its semantic self-hash is
`704d74479ca89c140857bea95d4b9709eb705f51ad42e4eb65a5000ec456b4b4`.
Dependabot PRs #24–#26 changed the dependency lock, so this append-only freeze supersedes
v3 without altering the measured cells. The audit verifies the runtime closure and
...
`artifacts/phase8_bridge/dispersion_audit_20260830_v9.json`. Its writer refuses any
