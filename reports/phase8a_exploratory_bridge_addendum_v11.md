# Phase 8A exploratory bridge addendum v11
...
**Current authority:** This addendum supersedes v10 for the Phase 8A interpretation. The
v1–v10 paths remain frozen as audit evidence.
...
| D | LightGBM | 0.003000 | 0.014645 | 0.20 | 0.003803 | 0.000850 | 5.04 | 2.45 |
| V | Gamma GLM | 0.003386 | 0.007664 | 0.44 | 0.007378 | 0.001650 | 1.36 | 1.67 |
| V | LightGBM | 0.006203 | 0.018778 | 0.33 | 0.008672 | 0.001939 | 2.83 | 4.88 |
...
reductions are 2.45-fold for D/LightGBM, 1.67-fold for V/Gamma GLM and 4.88-fold for
...
`49fccab99d7f2732be9dead1d5858380fa83d2deb8a2b18b65be5851b9633a0d`.
...
This current reference is the RP2-v3 timing-and-role remediation measured at commit
`cbdd0b5840da9ae685e2dff90a113ba33e7a7806`: bar roles are derived from partition dates,
B0 observes underlying bars only through the registered 120-second cutoff, and B1 uses
the same XNYS expiry-close calendar as B2. The Phase 8 cube and published Phase 8 cells
are unchanged; only the independently measured D/V comparison is superseded.
...
in `artifacts/phase8_bridge/dispersion_audit_producer_freeze_v5.json`. It contains the
...
`c7f200554283853aac3baf2fa2ea7c5498b1e4cbd6182dad29a758c7a2f139a6`, and
its semantic self-hash is
`5abe03a2881b41a6046a99aecf0fc95cccc8708b664a5572ca89c0717d351ce5`.
The RP2-v3 timing-and-partition-role remediation changed the executable closure, so this
append-only freeze supersedes v4 without altering the Phase 8 cells. The audit verifies
the runtime closure and registry binding before replay or measurement.
...
`artifacts/phase8_bridge/dispersion_audit_20260831_v10.json`. Its writer refuses any
