...
| [`phase8a_exploratory_bridge_addendum_v4.md`](phase8a_exploratory_bridge_addendum_v4.md) | Current post-cutoff Phase 8A interpretation: all Holm p-values for B1 and B2 conditional on B1, producer-bound current D/V comparison and historical-provenance limitation. |
...
and [`phase8a_exploratory_bridge_addendum_v3.md`](phase8a_exploratory_bridge_addendum_v3.md)
— frozen Phase 8A interpretations retained at their registered SHA-256 values; v4 is
current.
