# Phase 8A exploratory bridge addendum v4

**Evidence date:** 2026-08-30  
**Classification:** `MIXED_EXPLORATORY`  
**Claim boundary:** `EXPLORATORY_DESCRIPTIVE_NOT_CONFIRMATORY`  
**Current authority:** This addendum supersedes v3 for the Phase 8A interpretation. The
v1–v3 paths remain frozen as audit evidence.
...
`artifacts/phase8_bridge/dispersion_audit_20260830_v3.json`. Its writer refuses any
registered output path. The artifact records both D/V references, the verified current D/V
producer, the exact replay, the unresolved historical-producer identity, the unavailable
