# Phase 8A exploratory bridge addendum v8
...
**Current authority:** This addendum supersedes v7 for the Phase 8A interpretation. The
v1–v7 paths remain frozen as audit evidence.
...
in `artifacts/phase8_bridge/dispersion_audit_producer_freeze_v2.json`. It contains the
...
`50441ca7213db417b772772068b824f4f4fbcc55529789a54ce726628e610067`, and
its semantic self-hash is
`ede89e196877bc5505a27ac3d954238fa3cf329bc0a7619ac47ac82fc9d1f24a`.
Dependabot PRs #8 and #9 changed the dependency lock, so this append-only freeze supersedes
v1 without altering the measured cells. The audit verifies the runtime closure and
registry binding before replay or measurement.
...
`artifacts/phase8_bridge/dispersion_audit_20260830_v7.json`. Its writer refuses any
